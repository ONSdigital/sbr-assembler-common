...
//  )
  ...
  val newPeriodEnts = List(
    Enterprise(newEntErn,newRuPrn,None,"NEW ENTERPRISE LU", "1 Oxford Street", Some("THE HOUSE"),None,None,None,"W1A 1AA",None,"10001","1",Some("5"),"0","3","E12000007"),
    Enterprise("2000000011",entPrnWithMissingLouId,Some("9900000009"),"INDUSTRIES LTD","P O BOX 22",Some("INDUSTRIES HOUSE"),Some("WHITE LANE"),Some("REDDITCH"),Some("WORCESTERSHIRE"),"B22 2TL",Some("A"),"12345","3",Some("4"),"2","4","E12000009"),
    Enterprise("3000000011","0.311",Some("9900000126"),"BLACKWELLGROUP LTD","GOGGESHALL ROAD",Some("EARLS COLNE"),Some("COLCHESTER"),None,None,"CO6 2JX",Some("B"),"23456","4",Some("20"),"0","17","E12000006"),
    Enterprise("4000000011","0.411",Some("9900000242"),"IBM LTD","BSTER DEPT",Some("MAILPOINT A1F"),Some("P O BOX 41"),Some("NORTH HARBOUR"),Some("PORTSMOUTH"),"PO6 3AU",Some("C"),"34567","3",Some("8"),"2","7","E12000008"),
    Enterprise("5000000011","0.511",Some("9900000777"),"MBI LTD","99 Pen-Y-Lan Terrace",Some("Unit 11"),Some("Cardiff"),None,None,"CF23 9EU",Some("U"),"44044","1",Some("5"),"0","5","W99999999")
  )
