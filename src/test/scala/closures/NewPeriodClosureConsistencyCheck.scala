...
import common.closures.AssembleUnitsClosure
import common.dao.hbase.HBaseConnectionManager
import common.dao.parquet.ParquetDao
import common.global.AppParams
import common.model.domain._
import common.global.Configs._
import common.spark.extensions.rdd.HBaseDataReader._
...
/*  "dummy tests" should{
  ...
  "assembler" should {
    "create hfiles populated with expected enterprise data" in {
      ...
      val  lous = readEntitiesFromHFile
        [LocalUnit](louHfilePath).collect.toList
