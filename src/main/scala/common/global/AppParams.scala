...
import common.global.AppParams.{DEFAULT_GEO_PATH, DEFAULT_GEO_PATH_SHORT}
...
object AppParams{
  ...
  val DEFAULT_GEO_PATH = "src/test/resources/data/geo/test-dataset.csv"
  val DEFAULT_GEO_PATH_SHORT = "src/test/resources/data/geo/test_short-dataset.csv"
